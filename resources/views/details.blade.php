        ...
        <main class="d-flex">
            ...
            <div class="px-4 mt-3">
                <div class="d-flex">
                    <div class="w-50">
                        <div>
                            <img src="{{asset('/assets/img/car-1.svg')}}" class="w-100" alt="">
                        </div>
                        <div class="mt-3 d-flex justify-content-between">
                            <img src="{{asset('/assets/img/car-1.svg')}}" height="200" class="img-thumbnail img-fluid w-1-3" alt="">
                            <img src="{{asset('/assets/img/car-1.svg')}}"  class="img-thumbnail img-fluid w-1-3" alt="">
                            <img src="{{asset('/assets/img/car-1.svg')}}"  class="img-thumbnail img-fluid w-1-3" alt="">
                        </div>
                    </div>
                    <div class="w-50">
